...
import GetStatus from './Presence/GetStatus.js';
import type { ComponentMethod } from './Shelly/ListMethods.js';
import AddZone from './Presence/AddZone.js';
import DeleteZone from './Presence/DeleteZone.js';
import TiltCalibrate from './Presence/TiltCalibrate.js';
import LiveTrack from './Presence/LiveTrack.js';
import SetSensor from './Presence/SetSensor.js';
...
> {
  ...
  public static readonly key = 'presence';
  ...
  public async registerHomeyDevice(
    ...
    if (methods.includes('TiltCalibrate')) {
      await safeAddCapability(homeyDevice, 'button.calibrate_presence_tilt');
