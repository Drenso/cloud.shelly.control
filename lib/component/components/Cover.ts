...
import Calibrate from './Cover/Calibrate.js';
import type { RpcChannel } from '../../rpc/channel/RpcChannel.js';
import Open, { type CoverOpenParams } from './Cover/Open.js';
import Close, { type CoverCloseParams } from './Cover/Close.js';
import Stop from './Cover/Stop.js';
...
export default class Cover extends ComponentWithId<'Cover', CoverStatus, CoverConfig, CoverHomeySettings> {
  ...
  public static readonly key = 'cover';
