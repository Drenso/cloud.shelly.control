...
export type VoltmeterCheckExpressionParams = {
  /**
...
export type VoltmeterCheckExpressionResponse = {
  /**
...
export default async function CheckExpression(
  channel: RpcChannel,
  params: VoltmeterCheckExpressionParams,
): Promise<ResponseSuccessFrame<VoltmeterCheckExpressionResponse>> {
  const requestFrame = createRequestFrame('Voltmeter.CheckExpression', { ...params });
