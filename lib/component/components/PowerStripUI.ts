...
import GetConfig from './PowerStripUI/GetConfig.js';
import SetConfig from './PowerStripUI/SetConfig.js';
import GetStatus from './PowerStripUI/GetStatus.js';
...
> {
  ...
  protected static readonly key = 'powerstrip_ui';
