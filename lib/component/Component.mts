...
> {
  ...
  public static async unregister(_virtualDevice: VirtualDevice): Promise<void> {}
...
> extends Component<ComponentNameSpace, Status, Config, Settings> {
  ...
  public static async unregisterCapability(
    ...
    await homeyDevice.safeRemoveCapability(homeyCapability);
    await homeyDevice.safeRemoveCapability(multipleCapabilityId);
